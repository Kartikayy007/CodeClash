      ...
      <div className="p-16 bg-[#15171B] min-h-screen">
        ...
        <div className="grid grid-cols-12 gap-12">
          <div className="col-span-4 bg-[#1E2127] rounded-lg p-8">
            ...
            />
            <PersonalInfo email={profile?.email || ""} phone="Phone Number" />
            <Stats
              ...
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h3 className="text-white text-xl">
                    {profile?.totalMatches || 0} matches in one year
                  </h3>
              ...
              <ActivityCalendar
                ...
                handleNextMonth={() =>
                  setStartMonthIndex((prev) =>
                    Math.min(months.length - 4, prev + 1),
                  )
                }
              />
            </div>
